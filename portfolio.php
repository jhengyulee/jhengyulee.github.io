...
<body>
    <div class="container">
        ...
        <div class="tab-content" id="myTabContent">
            <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                ...
                <div class="container mt-4">
                    <div class="row justify-content-between">
                        ...
                        <div class="card" style="width: 18rem;">
                            <img src="./img/imagine.jpg" class="card-img-top" alt="...">
                            <div class="card-body">
            ...
            <div class="tab-pane fade" id="contact" role="tabpanel" aria-labelledby="contact-tab">333</div>
            <div class="tab-pane fade" id="contact" role="tabpanel" aria-labelledby="contact-tab">444</div>
        </div>
    </div>
